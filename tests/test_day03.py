...
# ======= solutons =========#
#############################
EXAMPLE_PART_ONE = 4361
EXAMPLE_PART_TWO = 467835
PART_ONE = 526404
PART_TWO = 84399773
...
def example_input() -> str:
    with open("inputs/day03_example.txt", "r") as f:
        return f.read()
...
#############################
@pytest.mark.bench
def test_day03(benchmark, real_input: str):
