...
# ======= solutons =========#
#############################
EXAMPLE_PART_ONE = 19114
EXAMPLE_PART_TWO = 167409079868000
PART_ONE = 434147
PART_TWO = 136146366355609
...
def example_input() -> str:
    with open("inputs/day19_example.txt", "r") as f:
        return f.read()
...
#############################
@pytest.mark.bench
def test_day19(benchmark, real_input: str):
